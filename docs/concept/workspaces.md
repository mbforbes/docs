...
1. Click the Create New Workspace button. This modal will appear:<br>
   ...
   1. Select the organization under which you want to create the workspace. We strongly recommend that AI2 employees choose the "AI2" organization. A workspace under an organization will by default be readable by others members of that organization.
